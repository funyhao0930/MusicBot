...
class WebUIExtendedAPITests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_root_and_assets_expose_the_animated_player_ui(self):
        ...
        # transport glyphs are inline SVG so their arrowheads, bars and halves can animate
        self.assertIn('class="transport-glyph"', html)
        self.assertIn('class="pp-l"', html)
        self.assertIn('id="repeat-one-badge"', html)
